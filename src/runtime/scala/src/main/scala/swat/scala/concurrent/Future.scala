 ...
 */
trait Future[+T] /* Swat excluded extends Awaitable[T] */ {
...
object Future {
  ...
  */
  ...
  // a side effect.
  private[concurrent] object InternalCallbackExecutor extends ExecutionContext /* Swat excluded with BatchingExecutor {
