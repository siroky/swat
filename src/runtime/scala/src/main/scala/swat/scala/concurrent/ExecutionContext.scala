 ...
 */
trait ExecutionContextExecutor // Swat excluded extends ExecutionContext with Executor

/**
 * Union interface since Java does not support union types
 */
trait ExecutionContextExecutorService // Swat excluded extends ExecutionContextExecutor with ExecutorService
...
object ExecutionContext {
  ...
  object Implicits {
     ...
     */
    implicit lazy val global: ExecutionContextExecutor = null // Swat excluded impl.ExecutionContextImpl.fromExecutor(null: Executor)
  }
