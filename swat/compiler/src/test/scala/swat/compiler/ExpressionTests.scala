...
class ExpressionTests extends CompilerSuite {
    ...
    test("Operators on AnyVal") {
        ...
        """ fragmentShouldCompileTo """
            ...
            var m = 'm';
            var n = 'n';
            -scala.Char$().toInt(m, 'scala.Char');
            (scala.Char$().toInt(m, 'scala.Char') * scala.Char$().toInt(n, 'scala.Char'));
            ~scala.Char$().toInt(m, 'scala.Char');
            (scala.Char$().toInt(m, 'scala.Char') & scala.Char$().toInt(n, 'scala.Char'));
            (scala.Char$().toInt(m, 'scala.Char') << scala.Char$().toInt(n, 'scala.Char'));
            (scala.Char$().toInt(m, 'scala.Char') < scala.Char$().toInt(n, 'scala.Char'));
    ...
    test("Methods on AnyVal") {
        ...
        """ fragmentShouldCompileTo """
            var x = 1;
            swat.hashCode(x);
            scala.Int$().toByte(x, 'scala.Int');
            scala.Int$().toDouble(x, 'scala.Int');
        """
    }
    ...
    test("Methods on String") {
        ...
        """ fragmentShouldCompileTo """
            var x = 'a';
            swat.hashCode(x);
            java.lang.String$().length(x, 'java.lang.String');
            java.lang.String$().substring(x, 3, 'java.lang.String, scala.Int');
        """
    }
}
