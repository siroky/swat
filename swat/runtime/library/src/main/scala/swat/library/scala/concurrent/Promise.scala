...
object Promise {
   ...
   */
  def apply[T](): Promise[T] = null // Swat TODO new impl.Promise.DefaultPromise[T]()
   ...
   *  @return         the newly created `Promise` object
   */
  def failed[T](exception: Throwable): Promise[T] = null // Swat TODO new impl.Promise.KeptPromise[T](Failure(exception))
   ...
   *  @return         the newly created `Promise` object
   */
  def successful[T](result: T): Promise[T] = null // Swat TODO new impl.Promise.KeptPromise[T](Success(result))
