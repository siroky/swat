package swat.api.js.html

import swat.api.js.events._
import swat.api.js.Date
import swat.api.js.dom.NodeList

trait Document extends swat.api.js.dom.Document with DocumentEvent with EventTarget {
